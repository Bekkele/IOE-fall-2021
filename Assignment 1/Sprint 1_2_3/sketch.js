...
I added to the origianl code. The circle graphic:
-is controlable with the potentiometer
-changes into a moon when button is pressed,
-background beceomes night when button is pressed
-light sensor grows and shrinks the circle graphic
*/
